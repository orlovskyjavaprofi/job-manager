...
class DeleteJobApplicationControllerTest extends BasicControllerTest {
	...
	@Test 
	public void checkIfRegUserCanAccessOwnJobApplicationDeletePage() throws Exception{
		 mockMvcLogin.perform(post("/submitNewUserReg")
	                ...
	                .andDo(mvcResult -> mockMvcLogin.perform(post("/loginAsUserToJobManger")
	                        ...
	                        .andDo(accessUserAccountOfficeComposePageMvcResult ->
	                                mockMvcLogin.perform(get("/memberarea/userAccountOffice/deleteApp/?uName=testdude000"))
	                                        .andExpect(status().isOk())
	...
	@Test
	public void checkIfAuthUserCanDeleteAnApplication() throws Exception{
		 mockMvcLogin.perform(post("/submitNewUserReg")
                 .param("userFirstName", "Thomas")
                 .param("userLastName", "Jefferson")
                 .param("userBirthDate", "01.12.1978")
